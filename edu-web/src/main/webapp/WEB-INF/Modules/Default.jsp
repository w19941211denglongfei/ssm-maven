...
<html>
<head>
<meta content="邓龙飞IT教育系统" name="keywords" />
<meta content="邓龙飞IT教育系统" name="description" />
					...
					<div class="header_tab">
						<ul>
							...
							<li><span class="header_hi">Hi,</span><span
								class="header_usename">邓龙飞</span>！</li>
				...
				<nav>
					<ul id="showMainNav" class="fix">
						...
						<li class="navContent">
							...
							onclick="Common.switchNavigation(this);"
							data-url="${pageContext.request.contextPath}/user/salary.do">工资管理</a>
						</li>
					</ul>
				</nav>
			</div>
